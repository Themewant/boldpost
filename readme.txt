...
* Bloggers who want to showcase their latest posts
* Magazine and news websites
* Portfolio sites displaying blog content
* Content marketers creating engaging layouts
* Anyone looking to improve their post display
...
= 1.0.0 =
* Initial release
* Post Grid block with responsive columns
* Post List block with flexible layouts
* Post Slider block with Swiper integration
* Category List block with styling options
