...
$style_handle = 'boldpo-post-slider-3-style';
$unique_id    = 'boldpo-' . wp_rand( 100, 99999 );
$selector     = '.boldpo-post-slider-3-block-wrap.' . $unique_id;

$full_responsive_css = BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-slider-3.style-' . $style, $responsive_data);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-slider-3.style-' . $style . ' .boldpo-list-item', $item_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-slider-3.style-' . $style . ' .boldpo-list-item .boldpo-blog-title', $title_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-slider-3.style-' . $style . ' .boldpo-list-item .boldpo-post-metas', $meta_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-slider-3.style-' . $style . ' .boldpo-list-item .boldpo-blog-excerpt', $excerpt_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-slider-3.style-' . $style . ' .boldpo-list-item .boldpo-blog-content', $content_padding_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-slider-3.style-' . $style . ' .boldpo-list-item .boldpo-blog-img img', $thumbnail_height_responsive);
...
BOLDPO_Helper::add_custom_style( $style_handle, $selector, $full_responsive_css, [
    '.boldpo-post-slider-3 .boldpo-list-item'    => BOLDPO_Helper::get_inline_styles($item_desktop),
    '.boldpo-post-slider-3 .boldpo-list-item:hover'    => BOLDPO_Helper::get_inline_styles($item_hover),
    '.boldpo-post-slider-3 .boldpo-list-item .boldpo-overlay-all'        => BOLDPO_Helper::get_inline_styles($overlay_styles),
    '.boldpo-post-slider-3 .boldpo-list-item .boldpo-blog-title a:hover' => BOLDPO_Helper::get_inline_styles($title_hover),
    '.boldpo-post-slider-3 .boldpo-list-item .boldpo-blog-excerpt a:hover'=> BOLDPO_Helper::get_inline_styles($excerpt_hover),
    '.boldpo-post-slider-3 .boldpo-list-item .boldpo-read-more .boldpo-read-more-link'     => BOLDPO_Helper::get_inline_styles($button_styles),
    '.boldpo-post-slider-3 .boldpo-list-item .boldpo-read-more .boldpo-read-more-link:hover'=> BOLDPO_Helper::get_inline_styles($button_hover),
    '.boldpo-post-slider-3 .boldpo-list-item .boldpo-blog-date-top'      => BOLDPO_Helper::get_inline_styles($td_styles),
    '.boldpo-post-slider-3 .boldpo-list-item .boldpo-post-metas'         => BOLDPO_Helper::get_inline_styles($metas_styles),
    '.boldpo-post-slider-3 .boldpo-list-item .boldpo-post-metas a'         => BOLDPO_Helper::get_inline_styles($meta_styles),
    '.boldpo-post-slider-3 .boldpo-list-item .boldpo-post-metas a:hover'         => BOLDPO_Helper::get_inline_styles($meta_hover),
    '.boldpo-post-slider-3 .boldpo-list-item .boldpo-post-metas i'         => BOLDPO_Helper::get_inline_styles($meta_icon_styles),
    '.boldpo-post-slider-3 .boldpo-list-item .boldpo-post-metas i:hover'         => BOLDPO_Helper::get_inline_styles($meta_icon_hover),
    '.boldpo-post-slider-3 .nav-btn'         => BOLDPO_Helper::get_inline_styles($navButtonStyles),
    '.boldpo-post-slider-3 .nav-btn:hover'   => BOLDPO_Helper::get_inline_styles($navButtonHoverStyles),
    '.boldpo-post-slider-3 .nav-btn .swiper-navigation-icon'   => BOLDPO_Helper::get_inline_styles($navBtnIconStyles),
    '.boldpo-post-slider-3 .swiper-pagination-bullet'         => BOLDPO_Helper::get_inline_styles($dotStyles),
    '.boldpo-post-slider-3 .swiper-pagination-bullet.swiper-pagination-bullet-active'   => BOLDPO_Helper::get_inline_styles($dotHoverStyles),
    '.boldpo-post-slider-3 .boldpo-list-item .boldpo-blog-img'   => BOLDPO_Helper::get_inline_styles($thumbnail_border_radius_styles),
...
?>
    <div <?php echo wp_kses_post(get_block_wrapper_attributes( array( 
        ...
        <div class="boldpo-post-slider-3 swiper boldpo-post-slider-3-<?php echo esc_attr($unique); ?> style-<?php echo esc_attr($style); ?>">
            ...
            <?php if( !empty($show_dots == true || $show_nav  == true) ) : ?>
                <div class="boldpo-post-slider-3-btn-wrapper boldpo-post-slider-3-btn-wrapper-<?php echo esc_attr($unique); ?>">
                    <?php 
                    if($show_dots) {
                        ?>
