...
$style_handle = 'boldpo-post-slider-4-style';
$unique_id    = 'boldpo-' . wp_rand( 100, 99999 );
$selector     = '.boldpo-post-slider-4-block-wrap.' . $unique_id;
...
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-slider-4.style-' . $style . ' .boldpo-list-item .boldpo-read-more-link', $button_text_align_responsive);
...
BOLDPO_Helper::add_custom_style( $style_handle, $selector, $full_responsive_css, [
    ...
    '.boldpo-post-slider-4 .boldpo-list-item .boldpo-blog-title a:hover' => BOLDPO_Helper::get_inline_styles($title_hover),
    '.boldpo-post-slider-4 .boldpo-list-item .boldpo-blog-excerpt a:hover'=> BOLDPO_Helper::get_inline_styles($excerpt_hover),
    '.boldpo-post-slider-4 .boldpo-list-item .boldpo-read-more-link'     => BOLDPO_Helper::get_inline_styles($button_styles),
    '.boldpo-post-slider-4 .boldpo-list-item .boldpo-read-more-link:hover'=> BOLDPO_Helper::get_inline_styles($button_hover),
...
?>
    <div <?php echo wp_kses_post(get_block_wrapper_attributes( array( 
        'class' => 'boldpo-block boldpo-post-slider-4-block-wrap ' . $unique_id,
