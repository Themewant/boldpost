...
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list.style-' . $style . ' .boldpo-list-item .boldpo-post-metas', $meta_responsive);
...
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list.style-' . $style . ' .boldpo-list-item .boldpo-list-item-inner .boldpo-blog-content', $content_padding_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list.style-' . $style . ' .boldpo-list-item .boldpo-list-item-inner .boldpo-blog-content', $content_width_responsive);
...
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list.style-' . $style . ' .boldpo-list-item .boldpo-read-more .boldpo-read-more-link', $button_text_align_responsive);
...
BOLDPO_Helper::add_custom_style( $style_handle, $selector, $full_responsive_css, [
    ...
    '.boldpo-post-list .boldpo-list-item .boldpo-read-more .boldpo-read-more-link'     => BOLDPO_Helper::get_inline_styles($button_styles),
    '.boldpo-post-list .boldpo-list-item .boldpo-read-more .boldpo-read-more-link:hover'=> BOLDPO_Helper::get_inline_styles($button_hover),
    '.boldpo-post-list .boldpo-list-item .boldpo-blog-date-top'      => BOLDPO_Helper::get_inline_styles($td_styles),
    '.boldpo-post-list .boldpo-list-item .boldpo-post-metas'         => BOLDPO_Helper::get_inline_styles($metas_styles),
    '.boldpo-post-list .boldpo-list-item .boldpo-post-metas span'         => BOLDPO_Helper::get_inline_styles($meta_styles),
    '.boldpo-post-list .boldpo-list-item .boldpo-post-metas span:hover'         => BOLDPO_Helper::get_inline_styles($meta_hover),
    '.boldpo-post-list .boldpo-list-item .boldpo-post-metas a'         => BOLDPO_Helper::get_inline_styles($meta_styles),
    '.boldpo-post-list .boldpo-list-item .boldpo-post-metas a:hover'         => BOLDPO_Helper::get_inline_styles($meta_hover),
    '.boldpo-post-list .boldpo-list-item .boldpo-post-metas i'         => BOLDPO_Helper::get_inline_styles($meta_icon_styles),
    '.boldpo-post-list .boldpo-list-item .boldpo-post-metas i:hover'         => BOLDPO_Helper::get_inline_styles($meta_icon_hover),
    '.boldpo-post-list .boldpo-list-item .boldpo-list-item-inner .boldpo-blog-content'       => BOLDPO_Helper::get_inline_styles($item_content_styles),
    ...
    '.boldpo-post-list .boldpo-list-item .boldpo-blog-img'   => BOLDPO_Helper::get_inline_styles($thumbnail_border_radius_styles),
...
$block_wrap_attr = get_block_wrapper_attributes( array( 'class' => 'boldpo-block boldpo-post-list-block-wrap ' . $unique_id . ' style-' . esc_attr($style) ) );
if ( empty( $block_wrap_attr ) ) {
    $block_wrap_attr = 'class="boldpo-block boldpo-post-list-block-wrap ' . esc_attr( $unique_id ) . ' style-' . esc_attr($style) . '"';
}
...
?>
    <div <?php echo wp_kses_post($block_wrap_attr); ?>>
        <div class="boldpo-post-list boldpo-row style-<?php echo esc_attr($style); ?> <?php echo esc_attr($gap_class); ?> <?php echo esc_attr($row_gap_class); ?>" <?php if ( 'numeric' !== $pagination_type ) { 
            $data_attr = $attributes;
            $data_attr['blockName'] = 'boldpost/post-list';
            ...
            while ( $query->have_posts() ) : $query->the_post();
                ...
                $reading_time = BOLDPO_Helper::boldpost_reading_time();
               
                $style_file = $template_pl_path . 'public/template-parts/post-list/style-' . $style . '.php';
