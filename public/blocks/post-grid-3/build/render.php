...
$per_page = isset($attributes['perPage']) ? $attributes['perPage'] : 4;
...
$wrap_middle_col_class = 'boldpo-col-lg-4 boldpo-col-md-4 boldpo-col-sm-12 boldpo-col-12';

// Columns
if ( $style == 'default' || $style == '1' ) {
    // 3-column layout: big-left | small-middle | big-right (each 1/3 width)
...
$title_left_typo_responsive = ['desktop' => [], 'tablet' => [], 'mobile' => []];
BOLDPO_Helper::add_responsive_vars($attributes, $title_left_typo_responsive, 'itemTitleLeftTypography', '', [
    'fontSize'=>'font-size', 
...
$title_middle_typo_responsive = ['desktop' => [], 'tablet' => [], 'mobile' => []];
BOLDPO_Helper::add_responsive_vars($attributes, $title_middle_typo_responsive, 'itemTitleMiddleTypography', '', [
    'fontSize'=>'font-size', 
    'fontWeight'=>'font-weight', 
    'lineHeight'=>'line-height', 
    'textTransform'=>'text-transform', 
...
$title_right_typo_responsive = ['desktop' => [], 'tablet' => [], 'mobile' => []];
BOLDPO_Helper::add_responsive_vars($attributes, $title_right_typo_responsive, 'itemTitleRightTypography', '', [
    'fontSize'=>'font-size', 
    'fontWeight'=>'font-weight', 
    'lineHeight'=>'line-height', 
    'textTransform'=>'text-transform', 
...
$thumbnail_middle_height_responsive = ['desktop' => [], 'tablet' => [], 'mobile' => []];
BOLDPO_Helper::add_responsive_vars($attributes, $thumbnail_middle_height_responsive, 'thumbnailMiddleHeight', 'height', [], false);

$style_handle = 'boldpo-post-grid-3-style';
...
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-grid-3.style-' . $style . ' .boldpo-grid-item .boldpo-blog-excerpt', $excerpt_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-grid-3.style-' . $style . ' .boldpo-grid-item .boldpo-blog-content', $content_padding_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-grid-3.style-' . $style . ' .boldpo-grid-col-left-wrap .boldpo-grid-item .boldpo-blog-img img', $thumbnail_left_height_responsive);   
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-grid-3.style-' . $style . ' .boldpo-grid-col-right-wrap .boldpo-grid-item .boldpo-blog-img img', $thumbnail_right_height_responsive);
...
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-grid-3.style-' . $style . ' .boldpo-grid-item .boldpo-read-more-link', $button_text_align_responsive);   


wp_enqueue_style( $style_handle );
BOLDPO_Helper::add_custom_style( $style_handle, $selector, $full_responsive_css, [
    '.boldpo-post-grid-3 .boldpo-grid-item .boldpo-grid-item-inner'    => BOLDPO_Helper::get_inline_styles($item_desktop),
    '.boldpo-post-grid-3 .boldpo-grid-item .boldpo-grid-item-inner:hover'    => BOLDPO_Helper::get_inline_styles($item_hover),
    '.boldpo-post-grid-3 .boldpo-grid-item .boldpo-overlay-all'        => BOLDPO_Helper::get_inline_styles($overlay_styles),
    '.boldpo-post-grid-3 .boldpo-grid-item .boldpo-blog-title a:hover' => BOLDPO_Helper::get_inline_styles($title_hover),
    '.boldpo-post-grid-3 .boldpo-grid-item .boldpo-blog-excerpt a:hover'=> BOLDPO_Helper::get_inline_styles($excerpt_hover),
    '.boldpo-post-grid-3 .boldpo-grid-item .boldpo-read-more-link'     => BOLDPO_Helper::get_inline_styles($button_styles),
    '.boldpo-post-grid-3 .boldpo-grid-item .boldpo-read-more-link:hover'=> BOLDPO_Helper::get_inline_styles($button_hover),
    '.boldpo-post-grid-3 .boldpo-grid-item .boldpo-blog-date-top'      => BOLDPO_Helper::get_inline_styles($td_styles),
    '.boldpo-post-grid-3 .boldpo-grid-item .boldpo-blog-metas'         => BOLDPO_Helper::get_inline_styles($metas_styles),
    '.boldpo-post-grid-3 .boldpo-grid-item .boldpo-blog-metas a'         => BOLDPO_Helper::get_inline_styles($meta_styles),
    '.boldpo-post-grid-3 .boldpo-grid-item .boldpo-blog-metas a:hover'   => BOLDPO_Helper::get_inline_styles($meta_hover),
    '.boldpo-post-grid-3 .boldpo-grid-item .boldpo-blog-metas i'       => BOLDPO_Helper::get_inline_styles($meta_icon_styles),
    '.boldpo-post-grid-3 .boldpo-grid-item .boldpo-blog-metas i:hover' => BOLDPO_Helper::get_inline_styles($meta_icon_hover),
...
$block_wrap_attr = get_block_wrapper_attributes( array( 'class' => 'boldpo-block boldpo-post-grid-3-block-wrap ' . $unique_id ) );
...
?>
    <div <?php echo wp_kses_post($block_wrap_attr); ?>>
        <div class="boldpo-post-grid-3 boldpo-row style-<?php echo esc_attr($style); ?> <?php echo esc_attr($gap_class); ?> <?php echo esc_attr($row_gap_class); ?>" 
             <?php if ($pagination_type !== 'numeric') {
                 $data_attr = $attributes;
                 $data_attr['blockName'] = 'boldpost/post-grid-3';
            ...
            while ( $query->have_posts() ) : $query->the_post();
                ...
                $style_file = $template_pl_path . 'public/template-parts/blog-grid-3/style-' . $style . '.php';
                ...
                if ( ($style == 'default' || $style == '1') && file_exists( $style_file ) ) {
                    ...
                    if ( $i == 1 ) {
                        ...
                        // Open MIDDLE SMALL POSTS wrapper (only if there are more than 2 posts)
                        ...
                        if ( $query->post_count > 2 ) {
                            // Close MIDDLE SMALL POSTS wrapper
                            echo '</div></div>';
                        }
