...
return array(
	'build' => array(
		...
		'apiVersion' => 3,
		'name' => 'boldpost/post-grid-3',
		'version' => '0.1.0',
		'title' => 'Post grid 3',
		'category' => 'boldpost',
		'description' => 'Post grid 3 Block',
		'example' => array(
		...
		'attributes' => array(
			...
			'thumbnailLeftHeightTablet' => array(
				'type' => 'string',
				'default' => ''
			),
			'thumbnailLeftHeightMobile' => array(
				'type' => 'string',
				'default' => ''
			),
			'thumbnailRightHeight' => array(
				'type' => 'string',
				'default' => '565px'
			),
			'thumbnailRightHeightTablet' => array(
				'type' => 'string',
				'default' => ''
			),
			'thumbnailRightHeightMobile' => array(
				'type' => 'string',
				'default' => ''
			),
			'thumbnailMiddleHeight' => array(
				'type' => 'string',
				'default' => '278px'
			),
			'thumbnailMiddleHeightTablet' => array(
				'type' => 'string',
				'default' => ''
			),
			'thumbnailMiddleHeightMobile' => array(
				'type' => 'string',
				'default' => ''
			),
			'perPage' => array(
