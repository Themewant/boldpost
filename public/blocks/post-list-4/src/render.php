...
$prev_button_margin = [];
if ( ! empty( $attributes['prevButtonMargin'] ) ) {
    if ( isset( $attributes['prevButtonMargin']['top'] ) ) $prev_button_margin['margin-top'] = BOLDPO_Helper::ensure_unit( $attributes['prevButtonMargin']['top'] );
    if ( isset( $attributes['prevButtonMargin']['right'] ) ) $prev_button_margin['margin-right'] = BOLDPO_Helper::ensure_unit( $attributes['prevButtonMargin']['right'] );
    if ( isset( $attributes['prevButtonMargin']['bottom'] ) ) $prev_button_margin['margin-bottom'] = BOLDPO_Helper::ensure_unit( $attributes['prevButtonMargin']['bottom'] );
    if ( isset( $attributes['prevButtonMargin']['left'] ) ) $prev_button_margin['margin-left'] = BOLDPO_Helper::ensure_unit( $attributes['prevButtonMargin']['left'] );
}

$next_button_margin = [];
if ( ! empty( $attributes['nextButtonMargin'] ) ) {
    if ( isset( $attributes['nextButtonMargin']['top'] ) ) $next_button_margin['margin-top'] = BOLDPO_Helper::ensure_unit( $attributes['nextButtonMargin']['top'] );
    if ( isset( $attributes['nextButtonMargin']['right'] ) ) $next_button_margin['margin-right'] = BOLDPO_Helper::ensure_unit( $attributes['nextButtonMargin']['right'] );
    if ( isset( $attributes['nextButtonMargin']['bottom'] ) ) $next_button_margin['margin-bottom'] = BOLDPO_Helper::ensure_unit( $attributes['nextButtonMargin']['bottom'] );
    if ( isset( $attributes['nextButtonMargin']['left'] ) ) $next_button_margin['margin-left'] = BOLDPO_Helper::ensure_unit( $attributes['nextButtonMargin']['left'] );
}
...
$style_handle = 'boldpo-post-list-4-style';
$selector     = '.boldpo-post-list-4-block-wrap.' . $unique_id;

$full_responsive_css = BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list-4.style-' . $style, $responsive_data);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list-4.style-' . $style . ' .boldpo-list-item .boldpo-list-item-inner', $item_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list-4.style-' . $style . ' .boldpo-list-item .boldpo-blog-title', $title_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list-4.style-' . $style . ' .boldpo-list-item .boldpo-post-metas', $meta_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list-4.style-' . $style . ' .boldpo-list-item .boldpo-blog-excerpt', $excerpt_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list-4.style-' . $style . ' .boldpo-list-item .boldpo-blog-content', $content_padding_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list-4.style-' . $style . ' .boldpo-list-item .boldpo-blog-content', $content_width_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list-4.style-' . $style . ' .boldpo-list-item .boldpo-blog-img', $thumbnail_width_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list-4.style-' . $style . ' .boldpo-list-item .boldpo-blog-img img', $thumbnail_height_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list-4.style-' . $style . ' .boldpo-list-item .boldpo-blog-img img', $thumbnail_width_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list-4.style-' . $style . ' .boldpo-list-item .boldpo-read-more .boldpo-read-more-link', $button_text_align_responsive);
...
BOLDPO_Helper::add_custom_style( $style_handle, $selector, $full_responsive_css, [
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-list-item-inner'    => BOLDPO_Helper::get_inline_styles($item_styles),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-list-item-inner:hover'    => BOLDPO_Helper::get_inline_styles($item_hover),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-overlay-all'        => BOLDPO_Helper::get_inline_styles($overlay_styles),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-blog-title a:hover' => BOLDPO_Helper::get_inline_styles($title_hover),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-blog-excerpt a:hover'=> BOLDPO_Helper::get_inline_styles($excerpt_hover),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-read-more .boldpo-read-more-link'     => BOLDPO_Helper::get_inline_styles($button_styles),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-read-more .boldpo-read-more-link:hover'=> BOLDPO_Helper::get_inline_styles($button_hover),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-blog-date-top'      => BOLDPO_Helper::get_inline_styles($td_styles),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-post-metas'         => BOLDPO_Helper::get_inline_styles($metas_styles),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-post-metas a'         => BOLDPO_Helper::get_inline_styles($meta_styles),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-post-metas a:hover'         => BOLDPO_Helper::get_inline_styles($meta_hover),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-post-metas i'         => BOLDPO_Helper::get_inline_styles($meta_icon_styles),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-post-metas i:hover'         => BOLDPO_Helper::get_inline_styles($meta_icon_hover),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-blog-content'       => BOLDPO_Helper::get_inline_styles($item_content_styles),
    ...
    '.boldpo-page-nav.boldpo-page-prev a, .boldpo-page-nav.boldpo-page-next a' => BOLDPO_Helper::get_inline_styles($pag_styles),
    '.boldpo-page-nav.boldpo-page-prev a:hover, .boldpo-page-nav.boldpo-page-next a:hover' => BOLDPO_Helper::get_inline_styles($pag_hover),
    '.boldpo-page-nav.boldpo-page-prev' => BOLDPO_Helper::get_inline_styles($prev_button_margin),
    '.boldpo-page-nav.boldpo-page-next' => BOLDPO_Helper::get_inline_styles($next_button_margin),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-video-wrapper iframe'   => BOLDPO_Helper::get_inline_styles($video_styles),
    '.boldpo-post-list-4 .boldpo-list-item .boldpo-blog-img'   => BOLDPO_Helper::get_inline_styles($thumbnail_border_radius_styles),
...
$block_wrap_attr = get_block_wrapper_attributes( array( 'class' => 'boldpo-block boldpo-post-list-4-block-wrap ' . $unique_id ) );

if ( empty( $block_wrap_attr ) ) {
    $block_wrap_attr = 'class="boldpo-block boldpo-post-list-4-block-wrap ' . esc_attr( $unique_id ) . '"';
}
...
if ( $paged > 1 ) {
    $prev_page = is_archive() ? get_pagenum_link( $paged - 1 ) : add_query_arg( $page_key, $paged - 1 );
}
...
?>
    <div <?php echo wp_kses_post($block_wrap_attr); ?>>
        <?php if ( $pagination_type == 'next_prev' ) : ?>
        <div class="boldpo-page-prev boldpo-page-nav">
            <a href="<?php echo esc_url($prev_page); ?>"><?php echo esc_html('Prev'); ?></a>
        </div>
        <?php endif; ?>
        <div class="boldpo-post-list-4 boldpo-row style-<?php echo esc_attr($style); ?> <?php echo esc_attr($gap_class); ?> <?php echo esc_attr($row_gap_class); ?>" <?php if ( 'numeric' !== $pagination_type ) { 
            $data_attr = $attributes;
            $data_attr['blockName'] = 'boldpost/post-list-4';
            ...
            while ( $query->have_posts() ) : $query->the_post();
                ...
                $style_file = BOLDPO_PL_PATH . 'public/template-parts/post-list/style-' . $style . '.php';
        ...
        <?php if ( $pagination_type == 'next_prev' && $next_page ) : ?>
        <div class="boldpo-page-next boldpo-page-nav">
            <a href="<?php echo esc_url($next_page); ?>"><?php echo esc_html('Next'); ?></a>
        </div>
        <?php endif; ?>
        <?php if ( $pagination_type !== 'next_prev' ) : ?>
