...
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list-2.style-' . $style . ' .boldpo-list-col-one-wrap .boldpo-list-item .boldpo-blog-img img', $thumbnail_one_height_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list-2.style-' . $style . ' .boldpo-list-col-two-wrap .boldpo-list-item .boldpo-blog-img img', $thumbnail_two_height_responsive);
$full_responsive_css .= BOLDPO_Helper::generate_responsive_css($selector . ' .boldpo-post-list-2.style-' . $style . ' .boldpo-list-item .boldpo-read-more-link', $button_text_align_responsive);
...
BOLDPO_Helper::add_custom_style( $style_handle, $selector, $full_responsive_css, [
    ...
    '.boldpo-post-list-2 .boldpo-list-item .boldpo-read-more-link'     => BOLDPO_Helper::get_inline_styles($button_styles),
    '.boldpo-post-list-2 .boldpo-list-item .boldpo-read-more-link:hover'=> BOLDPO_Helper::get_inline_styles($button_hover),
    '.boldpo-post-list-2 .boldpo-list-item .boldpo-blog-date-top'      => BOLDPO_Helper::get_inline_styles($td_styles),
    '.boldpo-post-list-2 .boldpo-list-item .boldpo-blog-metas'         => BOLDPO_Helper::get_inline_styles($metas_styles),
    '.boldpo-post-list-2 .boldpo-list-item .boldpo-blog-metas a'         => BOLDPO_Helper::get_inline_styles($meta_styles),
    '.boldpo-post-list-2 .boldpo-list-item .boldpo-blog-metas a:hover'         => BOLDPO_Helper::get_inline_styles($meta_hover),
    '.boldpo-post-list-2 .boldpo-list-item .boldpo-blog-metas i'         => BOLDPO_Helper::get_inline_styles($meta_icon_styles),
    '.boldpo-post-list-2 .boldpo-list-item .boldpo-blog-metas i:hover'         => BOLDPO_Helper::get_inline_styles($meta_icon_hover),
