...
BOLDPO_Helper::add_custom_style( $style_handle, $selector, $full_responsive_css, [
    ...
    '.boldpo-post-grid .boldpo-grid-item .boldpo-blog-metas .bldpost-meta'       => BOLDPO_Helper::get_inline_styles($meta_icon_styles),
    '.boldpo-post-grid .boldpo-grid-item .boldpo-blog-metas .bldpost-meta:hover' => BOLDPO_Helper::get_inline_styles($meta_icon_hover),
