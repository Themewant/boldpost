(function (window) {
    ...
    window.initBoldpoSliderPostTicker2 = function (scope) {
        ...
        wraps.forEach(function (wrap) {
            ...
            const sliderElement = wrap.querySelector('.boldpo-post-ticker-2-' + unique);
            ...
            try {
                ...
                new Swiper(sliderElement, {
                    ...
                    autoplay: wrap.dataset.autoplay !== 'false' ? {
                        delay: Number(wrap.dataset.autoplayDelay) || 3000,
